...
void HoymilesClass::initNRF(int8_t pin_mosi, int8_t pin_miso, int8_t pin_clk, int8_t pin_cs, int8_t pin_en, int8_t pin_irq)
{
    _radioNrf->init(pin_mosi, pin_miso, pin_clk, pin_cs, pin_en, pin_irq);
}
